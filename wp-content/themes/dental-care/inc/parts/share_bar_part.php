...
<div class="share-bar">
    ...
    <?php $post_image = urlencode(wp_get_attachment_url(get_post_thumbnail_id($post->ID))); ?>
    ...
    <ul class="share-bar-items">
        ...
        <li class="share-item-pi"><a href="http://pinterest.com/pin/create/button/?url=<?php echo esc_url($post_link); ?>&amp;media=<?php echo $post_image ?>" target='_blank' title="<?php esc_html_e('Share on Pinterest', 'dental-care'); ?>"><i class="fa fa-pinterest"></i> </a></li>
        ...
        <li class="share-item-tr"><a href="http://www.tumblr.com/share/link?url=<?php echo esc_url($post_link_tumb); ?>&amp;name=<?php echo $post_name; ?>" target='_blank' title="<?php esc_html_e('Share on Tumblr', 'dental-care'); ?>"><i class="fa fa-tumblr"></i> </a></li>
        <li class="share-item-dg"><a href="mailto:mail@email.com?subject=<?php echo $post_name; ?>&amp;body=Check%20this%20out:<?php echo esc_url($post_link); ?>" target='_blank' title="<?php esc_html_e('Mail to Friend', 'dental-care'); ?>"><i class="fa fa-envelope-o"></i> </a></li>
